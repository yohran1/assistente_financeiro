...
- app.supabase.com → Authentication → Settings → Site URL → `https://inteligentefinancas.vercel.app`
- Redirect URLs: `https://inteligentefinancas.vercel.app/**`, `http://localhost:3000/**`, `http://127.0.0.1:3000/**`
